  ...
  return (
    <View className='px-8 mt-16'>
      ...
      <View className='my-3'>
        ...
        <TextInput className='border border-gray-300 py-2 px-4 text-xl flex' placeholder='category' />
      </View>
      <View className='my-3'>
        <View className='mb-2 flex flex-row'>
      ...
      <View className='my-3'>
        ...
        <TouchableOpacity onPress={() => setDatePickerVisibility(!isDatePickerVisible)} className='border border-gray-300 py-2 px-4 text-lg flex flex-row items-center' >
